...
import { AiOutlineCalendar, AiFillCar,AiFillDashboard,AiOutlineForm,AiFillContacts } from 'react-icons/ai';
import { FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { BsKanban,BsWrench, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft } from 'react-icons/bs';
...
export const VehicleGrid = [
  ...
  { headerText: 'Status&location',
    width: '120',
    textAlign: 'Center',
    template: gridEmployeeCountry },

  { field: 'HireDate',
    headerText: 'DateofRenewal',
    width: '135',
    format: 'yMd',
    textAlign: 'Center' },

  { field: 'ReportsTo',
    headerText: 'CurrentOperator',
    width: '120',
    textAlign: 'Center' },
  { field: 'EmployeeID',
